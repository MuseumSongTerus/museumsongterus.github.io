...
const questions = [
	...
	{
        question: "Berikut merupakan gambar dari?",
        image: "resources/11.jpg",
        options: ["Fragmen gigi beruang", "Fragmen gigi gajah", "Fragmen gigi badak"],
        correctAnswer: "1"
    },
    {
        question: "Sangiran 17 diperkirakan hidup berapa tahun yang lalu?",
        image: "resources/12.jpg",
        options: ["800.000 – 700.000 tahun yang lalu", "650.000 – 550.000 tahun yang lalu", "500.000 – 400.000 tahun yang lalu"],
        correctAnswer: "0"
    },
	{
        question: "Kawasan Gunung Sewu terdiri dari daerah apa saja?",
        image: "resources/1_13.jpg",
        options: ["Bantul, Gunung kidul, Yogyakarta, Pacitan", "Pacitan, Bantul, Gunung kidul, Solo ", "Bantul, Gunung kidul, Wonogiri, Pacitan"],
        correctAnswer: "2"
    },
    {
        question: "Apa saja batuan penyusun di Kawasan Gunung Sewu?",
        image: "resources/14.jpg",
        options: ["Andesit, Gamping, Rijang", "Andesit, Rijang, Kapur", "Rijang, Gamping, Beliung"],
        correctAnswer: "0"
    },
	{
        question: "Berikut merupakan koleksi yang berfungsi sebagai pisau untuk memanen padi yang dinamakan?",
        image: "resources/15.jpg",
        options: ["Ana-Ana", "Uni-Uni", "Ani-Ani"],
        correctAnswer: "2"
    },
    {
    ...
    },
	{
        ...
        options: ["Ronthek ", "Rotek badul", "Kethek Ogleng"],
        correctAnswer: "0"
    },
    {
        question: "Bekal Kubur apa saja yang ditemukan dalam rangka Mbah Sayem?",
        image: "resources/5_18.jpg",
        options: ["Tengkorak Kijang dan Alat tulang ", "Tengkorak Monyet dan Alat Batu", "Tengkorak Kerbau dan Manik-Manik"],
        correctAnswer: "1"
    },
	{
        question: "Siapa Sosok pada Gambar diatas?",
        image: "resources/19.png",
        options: ["Van Koeningswald", "Susilo Bambang Yudhoyono", "Junghuhn"],
        correctAnswer: "0"
    },
    {
        question: "Pesta apa yang diselenggarakan oleh Van Koeningswald dan Twidie pada tahun 1935??",
        image: "resources/20.jpg",
        options: ["Pesta Makanan", "Pesta Alat Batu", "Pesta Wayang"],
        correctAnswer: "2"
    },
];
const totalQuestionsToShow = 10;
const totalQuestions = totalQuestionsToShow;

let selectedQuestions = [];

function getRandomQuestions() {
    const shuffled = questions.sort(() => 0.5 - Math.random()); // Shuffle the pool
    selectedQuestions = shuffled.slice(0, totalQuestionsToShow); // Select the first 10 questions
}
...
function createPagination() {
    ...
    selectedQuestions.forEach((_, index) => {  // Use selectedQuestions instead of questions
        $('#pagination').append(
...
$(document).ready(function () {
	getRandomQuestions(); // Call the function to select random questions
    startTimer();
    createPagination();
    loadQuestion();
});
